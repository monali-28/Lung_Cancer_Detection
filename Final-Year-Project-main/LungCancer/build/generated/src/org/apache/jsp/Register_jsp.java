...
public final class Register_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<li><a href=\"#\">Login <i class=\"icofont-rounded-down\"></i></a>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<ul class=\"dropdown\">\n");
      out.write("                                                                                                    <li><a href=\"DoctorLogin.jsp\">Doctor</a></li>\n");
      ...
      out.write("            <form class=\"form-signin w-100\" action=\"registerUser\" method=\"post\">\n");
      out.write("                <h2 class=\"form-signin-heading text-center\">User Registration</h2>\n");
      out.write("                \n");
      out.write("                <label class=\"label label-info\">Enter User Name</label>\n");
      out.write("                <input type=\"text\" class=\"form-control validate[required] mb-3\" placeholder=\"User Name\" name=\"dname\"/>\n");
      out.write("                \n");
      out.write("                <label class=\"label label-info\">Password</label>\n");
      out.write("                <input type=\"password\" class=\"form-control validate[required] mb-3\" placeholder=\"Password\" name=\"pass\"/>\n");
      out.write("                \n");
      out.write("                <label class=\"label label-info\">Education</label>\n");
      out.write("                <input type=\"text\" class=\"form-control validate[required] mb-3\" placeholder=\"Education\" name=\"edu\"/>\n");
      out.write("                \n");
      out.write("                <label class=\"label label-info\">Enter Mobile</label>\n");
      out.write("                <input type=\"text\" class=\"form-control validate[required] mb-3\" placeholder=\"Mobile\" name=\"mob\"/>\n");
      out.write("                \n");
      out.write("                <label class=\"label label-info\">Enter Email</label>\n");
      out.write("                <input type=\"email\" class=\"form-control validate[required] mb-3\" placeholder=\"Email\" name=\"email\"/>\n");
      out.write("                \n");
      out.write("                <button class=\"btn btn-primary w-100 mt-3\" type=\"submit\">Add</button>\n");
      out.write("            </form>\n");
      out.write("        </div>\n");
      out.write("    </div>\n");
      out.write("</div>\n");
