    ...
    <div class="col-md-6">
        <div class="row background p-4 rounded shadow">
            <form class="form-signin w-100" action="registerUser" method="post">
                ...
                <label class="label label-info">Enter User Name</label>
                ...
                <input type="email" class="form-control validate[required] mb-3" placeholder="Age" name="age"/>
                
                <label class="label label-info">Enter Weight</label>
                <input type="email" class="form-control validate[required] mb-3" placeholder="Weight" name="wt"/>
                
                <label class="label label-info">Enter Blood Group</label>
                <input type="email" class="form-control validate[required] mb-3" placeholder="Blood Group" name="bgrp"/>
