...
//        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String line = "";
            String idd=(String)session.getAttribute("did");
...
//             String d_precautions = multipartRequest.getParameter("d_precautions");
             String stage ="Second Stage";// multipartRequest.getParameter("stage");
//           
...
//            System.out.println("file name:" + text.getName());
            ...
            if(glcmfe.getDissimilarity()>=0.40){
            stage="Last Stage";
            }
            Statement statement = Dbcon.connect();

            String sql = "INSERT INTO `train_data` (`disese_name`, `disease_symp`, `disease_pre`, `disease_image`,`Contrast`,`Homogenity`,`Entropy`,`Energy`,`Dissimilarity`,`stage`,`did`) VALUES ('" + d_name + "','nil','nil','" + textfile + "','" + glcmfe.getContrast() + "','" + glcmfe.getHomogenity() + "','" + glcmfe.getEntropy() + "','" + glcmfe.getEnergy() + "','" + glcmfe.getDissimilarity() + "','"+stage+"','"+idd+"');";
...
//            }
 session.setAttribute("flash_message", "Added Product Successfully !!!");
            ...
            response.sendRedirect("viewTrainDataImage.jsp");
