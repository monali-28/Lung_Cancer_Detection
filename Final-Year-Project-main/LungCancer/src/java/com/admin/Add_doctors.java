 ...
 * @author Admin
 */
public class Add_doctors extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            String dedu = request.getParameter("edu");
            ...
            String sql = "INSERT INTO `doctor` (`did`, `dname`, `dpass`, `dedu`, `dexp`, `dmob`, `dmail`) VALUES (null,'" + dname + "','" + dpass + "','" + dedu + "','" + dexp + "','" + dmob + "','" + dmail+ "');";
